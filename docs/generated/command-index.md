...
| `search` | `src/commands/search.ts` | `<keyword>` | `--max <n>`<br>`--sort <sort>`<br>`--price-min <n>`<br>`--price-max <n>`<br>`--province <name>`<br>`--city <name>`<br>`--verified <kind>`<br>`--min-turnover <n>`<br>`--exclude-ads`<br>`--deeppro`<br>`--deeppro-delay-min <seconds>`<br>`--deeppro-delay-max <seconds>`<br>`--deeppro-output-dir <dir>`<br>`--deeppro-search-mode <mode>`<br>`--profile <name>`<br>`--headed` | Search 1688 by keyword |
...
| `image-search` | `src/commands/image-search.ts` | `<imagePathOrUrl>` | `--max <n>`<br>`--profile <name>`<br>`--headed`<br>`--debug-image` | Search 1688 by image (local file or http(s) URL) |
