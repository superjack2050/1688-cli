...
| `ImageSearchArgs` | `src/commands/image-search.ts` | `imagePath: string;`<br>`max: number;`<br>`headed?: boolean;`<br>`debugImage?: boolean;` |
| `ImageSearchOpts` | `src/commands/image-search.ts` | `imagePath: string;`<br>`max?: string;`<br>`profile?: string;`<br>`headed?: boolean;`<br>`debugImage?: boolean;` |
| `ImageSearchResult` | `src/commands/image-search.ts` | `imageId: string;`<br>`total: number;`<br>`rawTotal: number;`<br>`offers: Offer[];`<br>`lowConfidence?: boolean;`<br>`upload?: {`<br>`finalUrl: string;`<br>`previewSrc?: string \| null;`<br>`usedResultUrl?: string;`<br>`diagnostics?: unknown;` |
...
| `SearchOfferCaptureOptions` | `src/session/search-capture.ts` | `page: Page;`<br>`requireMethod?: string;`<br>`requireSortType?: string;`<br>`requireImageId?: string;`<br>`allowUnscopedWirelessRecommend?: boolean;`<br>`targetPage?: () => number;`<br>`keep?: 'first' \| 'largest';` |
